...
?>
	...
	<?php if($para){?>
				<?php if($s_GRP==""&&($s_LVL==0||$s_LVL==4||$s_LVL==2)&&$s==''){?>
					<a href="#" onclick="" data-toggle="modal" data-target="#modal_banyak" class="btn btn-warning pull-right"><i class="fa fa-plus"></i> Mass</a>
					<a href="#" onclick="$('#yakin').val('');$('#notes').html('');clearAuto();openForm(0);" data-toggle="modal" data-target="#modal_large" class="btn btn-info pull-right"><i class="fa fa-plus"></i> Create</a>
					<?php if($s_LVL==0&&$s_GRP==""){?>
					<a class="btn btn-danger pull-right" href="JavaScript:;" data-fancybox data-type="iframe" data-src="md_bi.php"><i class="fa fa-plus"></i> Batch</a>
				<?php }}?>
	<?php }else{?>
				<button class="btn btn-info pull-right" onclick="tblupdate()"><i class="fa fa-refresh"></i> Refresh</button>	
	<?php }?>
				</div>                   
	...
	<?php }?>
		...
		<div class="modal" id="modal_banyak" tabindex="-3" role="dialog" aria-labelledby="smallModalHead" aria-hidden="true">
                        ...
                        <form class="form-horizontal" id="myfx">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
                                            <input disabled id="dtm" name="dtm" type="text" class="form-control" placeholder="auto">
											<span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
									...
									<div class="col-md-4">
										<div class="input-group">
                                            <input id="dtx" name="dt" type="text" class="form-control" placeholder="<?php echo date('Y-m-d H:i')?>">
											<span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
										</div>
									</div>
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										<div class="input-group">
										<input type="text" class="form-control input-sm" name="iarea" id="iarea" placeholder="...">
										<span onclick="getOutletx();" class="input-group-addon add-on"><i class="fa fa-refresh"></i></span>
										</div>
									</div>
									<label class="col-md-2 control-label">Detail</label>
									<div class="col-md-4">
										<textarea class="form-control input-sm" name="d" id="dx" placeholder="..."></textarea>
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Jenis Layanan</label>
									<div class="col-md-10">
										<select multiple class="form-control selectpicker" name="st[]" id="stx">
										<?php echo $optst?>
										</select>
									</div>
								</div>
								<div class="form-group">
									...
									<div class="col-md-3">
										<select class="form-control" name="typ" id="typx" style="-webkit-appearance: menulist;">
										<?php echo $opttyp?>
										</select>
									</div>
									<label class="col-md-2 control-label">Outlet(s)</label>
									<div class="col-md-5">
										<textarea readonly class="form-control input-sm" name="outletx" id="outletx" placeholder="auto"></textarea>
										<textarea style="display:none;" readonly class="form-control input-sm" name="outlet" id="outlet" placeholder="auto"></textarea>
									</div>								
								</div>
							</div>
							</div>
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-4">
										...
										<select onchange="typChange();" class="form-control" name="typ" id="typ" style="-webkit-appearance: menulist;">
										<?php echo $opttyp?>
										</select>
									</div>
									<label class="col-md-2 control-label">Jenis Layanan</label>
									<div class="col-md-4">
										<select class="form-control" name="st" id="st" onchange="stChange();" style="-webkit-appearance: menulist;">
										<?php echo $optst?>
										</select>
									</div>
								...
								<?php if($s_LVL==4){?>
									...
									<div class="col-md-4 cls-grp">
										<select class="form-control class-grp" name="grp" id="grp" style="-webkit-appearance: menulist;">
										<?php echo $optgrp?>
										</select>
									</div>
								<?php }else{?>
								...
								<?php }?>
										...
										<div class="col-md-4 psbrelokmig" style="display:none;">
											<div class="input-group">
												<input id="tp" name="tp" type="text" class="form-control datepicker" placeholder="">
												<span class="input-group-addon add-on"><span class="glyphicon glyphicon-calendar"></span></span>
											</div>
										</div>
										<label class="col-md-2 control-label nonpsbrelokmig">Backup Link</label>
										<div class="col-md-4 nonpsbrelokmig" style="">
											<input id="buprovider" type="text" readonly class="form-control" placeholder="">
										</div>
								</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Kanwil</label>
										<div class="col-md-4">
											<input readonly type="text" class="form-control input-sm" name="kanwil" id="kanwil" placeholder="auto">
											<!--select class="form-control" name="kanwil" id="kanwil" onchange="$('#k').val($('#kanwil').val());" placeholder="auto">
											<?php echo $opt1?>
											</select-->
										</div>
										<label class="col-md-2 control-label">SID</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="sid" id="sid" placeholder="auto">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="ipwan" id="ipwan" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">IP LAN</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="iplan" id="iplan" placeholder="auto">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Area</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="area" id="area" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">Cabang</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="cabang" id="cabang" placeholder="auto">
										</div>
									</div>
									<!--div class="form-group">
										<label class="col-md-2 control-label">Name</label>
										<div class="col-md-4">
											<input disabled type="text" class="form-control input-sm" name="hx" id="hx" placeholder="auto">
										</div>
									</div-->
								</form>
								<br />
								<form class="form-horizontal" id="myfpic">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="pic" id="pic" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">PIC 2</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="pic2" id="pic2" placeholder="auto">
										</div>
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="contact" id="contact" placeholder="auto">
										</div>
										<label class="col-md-2 control-label">Contact 2</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="contact2" id="contact2" placeholder="auto">
										</div>
									</div>
								</form>
