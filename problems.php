						...
						<form class="form-horizontal" id="myf">
							...
							<div class="panel-body">
								...
								<div class="form-group">
									...
									<div class="col-md-10">
										<input type="text" class="form-control input-sm" name="probid" id="probid" placeholder="...">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Desc</label>
									<div class="col-md-10">
										<input type="text" class="form-control input-sm" name="probname" id="probname" placeholder="...">
									</div>
								</div>
								<div class="form-group">
									<label class="col-md-2 control-label">Group</label>
									<div class="col-md-10">
										<input type="text" class="form-control input-sm" name="grping" id="grping" placeholder="...">
									</div>
								</div>
