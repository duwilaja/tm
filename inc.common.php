...
$r_templates=array(
			...
			"Open,Close,Duration,Jenis,Nossa,Kanwil,Unit,Class,Nama,SID,Penyebab,Solusi,Link,Filtering,Gamas,Laporan,Jml.Hari,Hari,Triwulan,C/O",
			...
			if(MONTH(dt)=MONTH(closed) AND YEAR(dt)=YEAR(closed),'','Y') as co,ticketno",
