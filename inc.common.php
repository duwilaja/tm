...
$r_templates=array(
			...
			"Ticket#,Open,Close,Duration,Jenis,Nossa,Kanwil,Unit,Class,Nama,SID,Penyebab,Solusi,Link,Filtering,Gamas,Laporan,Jml.Hari,Hari,Triwulan,C/O,ShallClosed,By",
			...
			if(MONTH(dt)=MONTH(closed) AND YEAR(dt)=YEAR(closed),'','Y') as co,MY_CLOSED(s,solved,closed) as sc,t.updby,ticketno",
