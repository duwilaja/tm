                            ...
                            <div class="panel panel-default">
								<div class="panel-body">
									...
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="notel" id="notel" placeholder="...">
										</div>
										<label class="col-md-2 control-label">IP</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="iptel" id="iptel" placeholder="...">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">SN</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="sn" id="sn" placeholder="...">
										</div>
										<label class="col-md-2 control-label">Jenis</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="jenis" id="jenis" placeholder="...">
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="oidx" id="oidx" placeholder="...">
											<!--select class="form-control" name="oidx" id="oidx">
											<?php echo $opt1?>
											</select-->
										</div>
									</div>
									<div class="form-group">
										...
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="guna" id="guna" placeholder="...">
										</div>
										<label class="col-md-2 control-label">Status</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="stts" id="stts" placeholder="...">
										</div>
									</div>
									<div class="form-group">
										<label class="col-md-2 control-label">Tiket#</label>
										<div class="col-md-4">
											<input type="text" class="form-control input-sm" name="ticketno" id="ticketno" placeholder="...">
										</div>
									</div>
