...
switch($q){
	...
	case 'kao': $sql="select COUNT(DISTINCT kanwil) as tot_kanwil,COUNT(DISTINCT IF(LEFT(area,6) = 'Deputy',area,NULL)) as tot_area,count(oid) as tot_outlet from tm_outlets"; break;
}
