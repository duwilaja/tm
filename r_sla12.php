...
$cols="st,i,k,area,cabang,h,SUM(TIMESTAMPDIFF(SECOND,dt,closed)) as td"; //jadi - kalo dia <> closed
$cols="st,i,k,area,cabang,h,SUM(TIMESTAMPDIFF(SECOND,dt,IF(s='closed',closed,NOW()))) as td";
$cols="st,i,k,area,cabang,h,SUM(dur) as td,SUM(durwh) as tdwh";
$colsrc="";
$grpby="st,i,k,area,cabang,h";
//$cols="st,i,k,area,cabang,h,(TIMESTAMPDIFF(SECOND,dt,closed)) as td,DATEDIFF(closed,dt) as dd";
//$grpby="";
